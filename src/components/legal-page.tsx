...
> = {
  ...
  terms: {
    ...
    sections: [
      [
        "The service",
        "Text to Poster turns text briefs into up to four AI-generated image directions using APIMart's gpt-image-2.5-flare (GPT Image 2.5) endpoint. APIMart is the service provider; Text to Poster is not the model provider and does not claim provider endorsement. Availability, generation time, safety filtering, and output details can vary. You must be at least 13 years old or meet the higher minimum age required where you live.",
      ],
      [
        "Your material",
  ...
  "ai-policy": {
    ...
    sections: [
      [
        ...
        "The poster directions and images produced by the studio are generated by APIMart's gpt-image-2.5-flare endpoint, which uses GPT Image 2.5. The product marks results as AI-generated. Outputs are not photographs, eyewitness evidence, or guaranteed statements of fact.",
      ],
      [
        "Underlying model disclosure",
        "The underlying image model used for text-to-poster generation is GPT Image 2.5, accessed through APIMart's gpt-image-2.5-flare endpoint. APIMart is the integration and hosting provider. If the model or provider changes, we will update this policy and the product disclosure.",
      ],
      [
        "Before you publish",
